                ...
                <div className="colFooter">
                    ...
                    <div className="listLink">
                        <div className="itemLink">
                            <Link href="https://www.facebook.fr" target='_blank'><i className="icon-footer icon-fb"></i></Link>
                        </div>
                        <div className="itemLink">
                            <Link href="https://www.linkedin.com/in/andriamahay-henikaja-irimanana/" target='_blank'><i className="icon-footer icon-linkedin"></i></Link>
                        </div>
                    </div>
                </div>
            </div> 
