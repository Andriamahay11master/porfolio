...
export default function Contact({
  ...
  const handleChange = (
    ...
    setFormErrors((prevErrors) => {
      ...
      const updatedIssues = prevErrors.issues.filter(
        (issue) => issue.path[0] !== event.target.name
      );
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-control ${
                    formErrors?.issues.find((issue) => issue.path[0] === "name")
                      ? "error"
                      : ""
                  }`}
                  type="text"
                  ...
                  onFocus={handleFocus}
                />
                {formErrors?.issues.map(
                  (issue) =>
                    issue.path[0] === "name" && (
                      <p className="error-message" key={issue.message}>
                        {issue.message}
                      </p>
                    )
                )}
